...
const Checkout = () => {
  useEffect(() => {
    const paymentNinePayObj = {
      env: 'SANDBOX',
      baseEncode:
        '',
      signature: 'oWHwj3oNsQgxMp3QISpRzGMbHvCr9sM+m0/HeLZaufk=',
    };
